...
# with subfolders for instrument categories (e.g. "Wavetable").  We only store the
...
class WavetableParamEditorHandler(BaseHandler):
    ...
    def handle_post(self, form):
        ...
        values = extract_parameter_values(preset_path, ("wavetable",))
        params_html = ''
        param_count = 0
        ...
        param_info = extract_available_parameters(preset_path, ("wavetable",))
